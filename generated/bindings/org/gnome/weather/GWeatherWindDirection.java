...
final class GWeatherWindDirection extends Plumbing
{
    private GWeatherWindDirection() {}
    ...
    static final int NNE = 2;

    static final int NE = 3;

    static final int ENE = 4;

    static final int E = 5;

    static final int ESE = 6;

    static final int SE = 7;

    static final int SSE = 8;
    ...
    static final int WSW = 12;

    static final int W = 13;

    static final int WNW = 14;
