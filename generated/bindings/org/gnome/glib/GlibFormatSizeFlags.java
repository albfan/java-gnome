...
final class GlibFormatSizeFlags extends Plumbing
{
    ...
    private static native final int get_ordinal_default();

    static final int LONG_FORMAT = get_ordinal_long_format();

    private static native final int get_ordinal_long_format();

    static final int IEC_UNITS = get_ordinal_iec_units();

    private static native final int get_ordinal_iec_units();

    static final int BITS = get_ordinal_bits();

    private static native final int get_ordinal_bits();
}
