...
final class GdkEventType extends Plumbing
{
    ...
    static final int DOUBLE_BUTTON_PRESS = 5;

    static final int TRIPLE_BUTTON_PRESS = 6;
    ...
    static final int TOUCH_BEGIN = 37;

    static final int TOUCH_UPDATE = 38;

    static final int TOUCH_END = 39;

    static final int TOUCH_CANCEL = 40;

    static final int TOUCHPAD_SWIPE = 41;

    static final int TOUCHPAD_PINCH = 42;

    static final int PAD_BUTTON_PRESS = 43;

    static final int PAD_BUTTON_RELEASE = 44;

    static final int PAD_RING = 45;

    static final int PAD_STRIP = 46;

    static final int PAD_GROUP_MODE = 47;

    static final int EVENT_LAST = 48;
}
