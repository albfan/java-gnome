...
final class GdkWindowTypeHint extends Plumbing
{
    ...
    static final int DROPDOWN_MENU = 8;

    static final int POPUP_MENU = 9;

    static final int TOOLTIP = 10;

    static final int NOTIFICATION = 11;

    static final int COMBO = 12;

    static final int DND = 13;
}
