...
final class GdkDragAction extends Plumbing
{
    ...
    private static native final int get_ordinal_copy();

    static final int MOVE = get_ordinal_move();

    private static native final int get_ordinal_move();
    ...
    private static native final int get_ordinal_private();

    static final int ASK = get_ordinal_ask();

    private static native final int get_ordinal_ask();
}
