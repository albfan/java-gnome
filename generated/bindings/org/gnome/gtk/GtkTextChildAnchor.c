...
#include "org_gnome_gtk_GtkTextChildAnchor.h"
...
Java_org_gnome_gtk_GtkTextChildAnchor_gtk_1text_1child_1anchor_1get_1widgets
(
	JNIEnv* env,
	jclass cls,
	jlong _self
)
{
	...
	// call function
	result = gtk_text_child_anchor_get_widgets(self);
