...
final class GtkApplicationInhibitFlags extends Plumbing
{
    ...
    private static native final int get_ordinal_logout();

    static final int SWITCH = get_ordinal_switch();

    private static native final int get_ordinal_switch();

    static final int SUSPEND = get_ordinal_suspend();

    private static native final int get_ordinal_suspend();

    static final int IDLE = get_ordinal_idle();

    private static native final int get_ordinal_idle();
}
