...
final class GtkDestDefaults extends Plumbing
{
    ...
    private static native final int get_ordinal_motion();

    static final int HIGHLIGHT = get_ordinal_highlight();

    private static native final int get_ordinal_highlight();

    static final int DROP = get_ordinal_drop();

    private static native final int get_ordinal_drop();
