...
final class GtkRecentFilterFlags extends Plumbing
{
    ...
    private static native final int get_ordinal_application();

    static final int GROUP = get_ordinal_group();

    private static native final int get_ordinal_group();

    static final int AGE = get_ordinal_age();

    private static native final int get_ordinal_age();
}
