...
#include "org_gnome_gtk_GtkMenuBar.h"

JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkMenuBar_gtk_1menu_1bar_1new
(
	JNIEnv* env,
	jclass cls
)
...
Java_org_gnome_gtk_GtkMenuBar_gtk_1menu_1bar_1set_1child_1pack_1direction
(
	JNIEnv* env,
	jclass cls,
	jlong _self,
...
)
{
	...
	// convert parameter childPackDir
	childPackDir = (GtkPackDirection) _childPackDir;

	// call function
	gtk_menu_bar_set_child_pack_direction(self, childPackDir);

	// cleanup parameter self

	// cleanup parameter childPackDir
}
