...
#include "org_gnome_gtk_GtkCheckButton.h"

JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkCheckButton_gtk_1check_1button_1new
(
	JNIEnv* env,
	jclass cls
)
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkCheckButton_gtk_1check_1button_1new_1with_1label
(
	JNIEnv* env,
	jclass cls,
	jstring _label
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkCheckButton_gtk_1check_1button_1new_1with_1mnemonic
(
	JNIEnv* env,
	jclass cls,
	jstring _label
