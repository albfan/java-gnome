...
#include "org_gnome_gtk_GtkOffscreenWindow.h"
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkOffscreenWindow_gtk_1offscreen_1window_1get_1surface
(
	JNIEnv* env,
	jclass cls,
	jlong _self
)
{
	...
	// call function
	result = gtk_offscreen_window_get_surface(self);
