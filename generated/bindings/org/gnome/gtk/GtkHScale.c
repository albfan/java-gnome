...
#include "org_gnome_gtk_GtkHScale.h"

JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkHScale_gtk_1hscale_1new
(
	JNIEnv* env,
	jclass cls,
	jlong _adjustment
)
{
	...
	// call function
	result = gtk_hscale_new(adjustment);
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkHScale_gtk_1hscale_1new_1with_1range
(
	JNIEnv* env,
	jclass cls,
	jdouble _min,
