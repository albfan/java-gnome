...
#include "org_gnome_gtk_GtkSwitch.h"
...
JNIEXPORT jboolean JNICALL
Java_org_gnome_gtk_GtkSwitch_gtk_1switch_1get_1state
(
	JNIEnv* env,
	jclass cls,
	jlong _self
)
{
	...
	// call function
	result = gtk_switch_get_state(self);
...
JNIEXPORT void JNICALL
Java_org_gnome_gtk_GtkSwitch_gtk_1switch_1set_1state
(
	JNIEnv* env,
	jclass cls,
	jlong _self,
