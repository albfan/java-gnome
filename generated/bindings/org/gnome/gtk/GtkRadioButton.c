...
#include "org_gnome_gtk_GtkRadioButton.h"
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkRadioButton_gtk_1radio_1button_1new_1with_1label
(
	JNIEnv* env,
	jclass cls,
	jlongArray _group,
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkRadioButton_gtk_1radio_1button_1new_1with_1label_1from_1widget
(
	JNIEnv* env,
	jclass cls,
	jlong _radioGroupMember,
...
)
{
	...
	// call function
	result = gtk_radio_button_new_with_label_from_widget(radioGroupMember, label);
...
)
{
	...
	// call function
	result = gtk_radio_button_new_with_mnemonic_from_widget(radioGroupMember, label);
...
Java_org_gnome_gtk_GtkRadioButton_gtk_1radio_1button_1get_1group
(
	JNIEnv* env,
	jclass cls,
	jlong _self
)
{
	...
	// call function
	result = gtk_radio_button_get_group(self);
...
Java_org_gnome_gtk_GtkRadioButton_gtk_1radio_1button_1join_1group
(
	JNIEnv* env,
	jclass cls,
	jlong _self,
...
{
	GtkRadioButton* self;
	GtkRadioButton* groupSource;

	// convert parameter self
	self = (GtkRadioButton*) _self;

	// convert parameter groupSource
	groupSource = (GtkRadioButton*) _groupSource;

	// call function
	gtk_radio_button_join_group(self, groupSource);
