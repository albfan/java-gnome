...
#include "org_gnome_gtk_GtkRecentChooserDialog.h"
...
JNIEXPORT jlong JNICALL
Java_org_gnome_gtk_GtkRecentChooserDialog_gtk_1recent_1chooser_1dialog_1new_1for_1manager
(
	JNIEnv* env,
	jclass cls,
	jstring _title,
...
)
{
	...
	// call function
	result = gtk_recent_chooser_dialog_new_for_manager(title, parent, manager, firstButtonText, NULL);
