...
#include "org_gnome_gtk_GtkTest.h"

JNIEXPORT jboolean JNICALL
Java_org_gnome_gtk_GtkTest_gtk_1test_1widget_1click
(
	JNIEnv* env,
	jclass cls,
	jlong _self,
...
)
{
	...
	// call function
	result = gtk_test_widget_click(self, button, modifiers);
...
JNIEXPORT jboolean JNICALL
Java_org_gnome_gtk_GtkTest_gtk_1test_1widget_1send_1key
(
	JNIEnv* env,
	jclass cls,
	jlong _self,
...
)
{
	...
	// call function
	result = gtk_test_widget_send_key(self, keyval, modifiers);
