...
final class PangoWeight extends Plumbing
{
    ...
    static final int THIN = 100;

    static final int ULTRALIGHT = 200;

    static final int LIGHT = 300;

    static final int SEMILIGHT = 350;

    static final int BOOK = 380;
    ...
    static final int ULTRABOLD = 800;

    static final int HEAVY = 900;

    static final int ULTRAHEAVY = 1000;
}
